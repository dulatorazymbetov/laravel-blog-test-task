<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    <h2 class="mb-5 text-2xl font-semibold text-gray-900">{{ __('blog.comments') }}</h2>
    @auth
        ...
        <button wire:click="postComment"
            ...
            {{ __('blog.post_comment') }}
        </button>
    @else
        <a wire:navigate class="py-1 text-orange-500 underline" href="{{ route('login') }}">{{ __('blog.login_to_comment') }}</a>
    @endauth
