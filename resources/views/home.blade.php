<x-app-layout title="Home Page">
    @section('hero')
        <div class="w-full py-32 text-center">
            <h1 class="text-2xl font-bold text-center text-gray-700 md:text-3xl lg:text-5xl">
                <span class="text-orange-500">&lt;Laravel Blog&gt;</span>
            </h1>
    ...
    <div class="w-full mb-10">
        <div class="mb-16">
            <h2 class="mt-16 mb-5 text-3xl font-bold text-orange-500"> {{ __('home.featured_posts') }} </h2>
            <div class="w-full">
            ...
            <a class="block mt-10 text-lg font-semibold text-center text-orange-500" href="{{ route('posts.index') }}">
                {{ __('home.more_posts') }}</a>
        </div>
        <hr>

        <h2 class="mt-16 mb-5 text-3xl font-bold text-orange-500">{{ __('home.latest_posts') }}</h2>
